...
export function Hero() {
  return (
    <section className="relative flex min-h-screen items-center justify-center overflow-hidden bg-[var(--dark)]">
      <div
      ...
      <div className="relative z-10 mx-auto max-w-4xl px-6 text-center">
        <p className="mb-6 text-xs font-bold uppercase tracking-[0.25em] text-[var(--gp-secondary)]">
          GridPower
        </p>
