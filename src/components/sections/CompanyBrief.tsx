  ...
  return (
    <section className="bg-white py-24 md:py-32">
      <div className="mx-auto max-w-3xl px-6 text-center">
        ...
        <p className="mx-auto mt-6 max-w-xl text-base leading-relaxed text-[var(--foreground-muted)]">
        ...
        <p className="mt-8 text-xs font-bold uppercase tracking-[0.15em] text-[var(--foreground-muted)]">
