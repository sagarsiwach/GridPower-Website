  ...
  return (
    <main>
      ...
      <section className="py-24">
        <div className="mx-auto max-w-4xl px-6">
          <h2 className="mb-12 text-center text-2xl font-bold tracking-tight text-fg">
            Timeline
          </h2>
          <div className="grid gap-8 md:grid-cols-3">
            {timeline.map((item) => (
              <div key={item.year} className="text-center">
                <p className="text-3xl font-extrabold text-gp-primary">
                  {item.year}
                </p>
      ...
      <section className="bg-bg-tint py-24">
        <div className="mx-auto max-w-4xl px-6 text-center">
          ...
          <p className="mb-12 text-sm text-fg-muted">
          ...
          <div className="grid gap-8 sm:grid-cols-3">
            {["Leadership", "Engineering", "Operations"].map((dept) => (
              ...
              >
                <div className="mx-auto mb-4 h-20 w-20 rounded-full bg-bg-tint" />
